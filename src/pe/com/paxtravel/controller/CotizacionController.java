...
public class CotizacionController {
	...
	public ModelAndView grabarCotiPaquete(HttpServletRequest request,
		...
		try {
			...
			/*
			 * //1- TIPO DE PROGRAMA int tipoPrograma =
			 * cotizacionBean.getIdTipoPrograma();
			 * 
			 * //2- PRESUPUESTO: ALTO, MEDIO, BAJO double
			 * precioPresupuestoPrograma =
			 * cotizacionBean.getPresupuestoMaximo(); PaqueteManagerBean
			 * oPaquete = new PaqueteManagerBean();
			 * oPaquete.setImPrecio(precioPresupuestoPrograma);
			 * oPaquete.setIdTipoPaquete(tipoPrograma);
			 * 
			 * //3- MODELO DESTINOS: A, B Y C List<PaqueteManagerBean>
			 * listPaqueteSearch = new ArrayList<PaqueteManagerBean>();
			 ...
			 * Alto, Medio y Bajo for ( int i=0; i<3; i++ ) {
			 * 
			 * if (i == 0) { //3.1- Primera Iteracion: Presupuesto ALTO
			 * oPaquete.setImPrecioMax(oPaquete.getImPrecioMaxAlto());
			 * oPaquete.setImPrecioMin(oPaquete.getImPrecioMinAlto());
			 * oPaquete.setTiPresupuestoValue("Alto"); listCotizacionManBeanAlto
			 * = cotizacionService.listarPaquete(oPaquete); for
			 * (PaqueteManagerBean o:listCotizacionManBeanAlto){ if (
			 * !listPaqueteSearch.contains(o) ) {
			 * System.out.println("listPaqueteSearch[id_paquete:"
			 * +o.getIdPaquete(
			 * )+", nombre:"+o.getNomPaquete()+", comentario:"+o.
			 * getComentario()+
			 * ", im_precio:"+o.getImPrecio()+", tipoPresupuesto:"
			 * +o.getTiPresupuestoValue()+"]"); listPaqueteSearch.add(o); } } }
			 * else if (i ==1){ //3.2- Segunda Iteracion: Presupuesto MEDIO
			 ...
			 * listCotizacionManBeanMedio =
			 * cotizacionService.listarPaquete(oPaquete); for
			 * (PaqueteManagerBean o:listCotizacionManBeanMedio){ if (
			 * !listPaqueteSearch.contains(o) ) {
			 * System.out.println("listPaqueteSearch[id_paquete:"
			 * +o.getIdPaquete(
			 * )+", nombre:"+o.getNomPaquete()+", comentario:"+o.
			 ...
			 * ", im_precio:"+o.getImPrecio()+", tipoPresupuesto:"
			 * +o.getTiPresupuestoValue()+"]"); listPaqueteSearch.add(o); } } }
			 * else if (i == 2){ //3.3- Tercera Iteracion: Presupuesto BAJO
			 * oPaquete.setImPrecioMax(oPaquete.getImPrecioMaxBajo());
			 * oPaquete.setImPrecioMin(oPaquete.getImPrecioMinBajo());
			 * oPaquete.setTiPresupuestoValue("Bajo"); listCotizacionManBeanBajo
			 * = cotizacionService.listarPaquete(oPaquete); for
			 * (PaqueteManagerBean o:listCotizacionManBeanBajo){ if (
			 * !listPaqueteSearch.contains(o) ) {
			 * System.out.println("listPaqueteSearch[id_paquete:"
			 * +o.getIdPaquete(
			 * )+", nombre:"+o.getNomPaquete()+", comentario:"+o.
			 ...
			 * listPaqueteSearch();
			 * 
			 * //Se filtran todos los destinos para estos paquetes y se guardan
			 * en: destinosList(); oPaquete.setList(cotizacionDestinos);
			 * List<PaqueteManagerBean> destinosList =
			 * cotizacionService.listarPaqueteDestino(oPaquete); List<Integer>
			 * paqueteIds = new ArrayList<Integer>();
			 * 
			 * //4- PAQUETES
			 * System.out.println("Paquetes finales.......................");
			 * for (PaqueteManagerBean o:destinosList) { if (
			 * !paqueteIds.contains(o.getIdPaquete()) ) {
	...
	public ModelAndView grabarCotiTicket(HttpServletRequest request,
		...
		try {
			 ...
			 * System.out.println("Cantidad de Destinos: " + destino.length);
			 * 
			 * CotizacionDetalleBean cotizacionDetalleBean = new
			 * CotizacionDetalleBean();
			 * cotizacionDetalleBean.setNumeroCotizacion
			 * (cotizacionBean.getNumeroCotizacion());
			 * 
			 * String g[];
			 * 
			 * if (destino.length > 0){ for (int i = 0; i < destino.length; i++)
			 * {
			 * 
			 * g = destino[i].split("_");
			 * 
			 ...
			 * 
			 * int res = cotizacionService.registrarCotizacionDetalleTicket(
			 * cotizacionDetalleBean);
			 * 
			 * System.out.println("registrarMotivo("+g[0] + "/" + g[1] +") " +
			 * res);
			 * 
			 * } }
			 * 
	...
	public ModelAndView grabarTransaccionCotizacion(HttpServletRequest request,
			HttpServletResponse response) {
		...
		try {
			...
			String tipoCotizacion = (request.getParameter("tipoCotizacion") == null ? ""
					: request.getParameter("tipoCotizacion"));
			...
			if (tipoCotizacion.equals("")) {
				...
				cotizacionBean.setFechaCotizacion(Utils
						.stringToStringyyyyMMdd(cotizacionBean
								.getFechaCotizacion()));
				cotizacionBean.setIdCliente(Integer.parseInt(idCliente));
				cotizacionBean.setNumeroCotizacion(cotizacionService
				...
				String motivoViaje = request.getParameter("motivoViaje");
				String servicioAdicional = request
						.getParameter("servAdicional");
				// MOTIVO DE VIAJE
				motivoViaje = motivoViaje
						.substring(0, motivoViaje.length() - 1);
				String motivo[] = motivoViaje.split(",");
				 ...
				 * String flagIda = request.getParameter("flagIda"); String
				 * flagRuta = request.getParameter("flagRuta");
				 * 
				 * String[] datos = datosVuelos.split(";");
				 * 
				 * int cantidadAdulto = 0; int cantidadNino= 0; String[] fila =
				 * null; CotizacionDetalleBean cotizacionDetalleBean = new
				 * CotizacionDetalleBean();
				 * cotizacionDetalleBean.setNumeroCotizacion
				 * ((String)cotizacionBeanMap.get("numeroCotizacion")); for (int
				 * i = 0; i < datos.length; i++) { fila = datos[i].split(",");
				 ...
				 * )); cotizacionDetalleBean.setCantidadAdulto(Integer.parseInt(
				 * fila[4] )); cotizacionDetalleBean.setCantidadNino(
				 * Integer.parseInt( fila[5] ));
				 * cotizacionDetalleBean.setIdaVuelta( Integer.parseInt(
				 * flagIdaVuelta) ); cotizacionDetalleBean.setIda(
				 * Integer.parseInt( flagIda) ); cotizacionDetalleBean.setRuta(
				 * Integer.parseInt(flagRuta) );
				 * 
				 * cotizacionService.registrarCotizacionDetalleTicket(
				 * cotizacionDetalleBean); }
				 */

				// BeanUtils.populate(cotizacionBean, cotizacionBeanMap);

				cotizacionBean.setNumeroCotizacion((String) cotizacionBeanMap
						.get("numeroCotizacion"));
				cotizacionBean.setFechaCotizacion(Utils
						.stringToStringyyyyMMdd((String) cotizacionBeanMap
								.get("fechaCotizacion")));
				cotizacionBean.setDescripcion((String) cotizacionBeanMap
						.get("descripcion"));
				...
				cotizacionBean.setIdCliente(Integer.parseInt(idCliente));
				int registro = cotizacionService
						.registrarCotizacionTicket(cotizacionBean);
