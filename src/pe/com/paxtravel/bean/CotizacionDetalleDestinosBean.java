...
public class CotizacionDetalleDestinosBean {

	private int idCotiza;
	private int idCliente;
	private String nuCotiza;
	private String feCotiza;
	...
	public String getNuCotiza() {
		return nuCotiza;
	}

	public void setNuCotiza(String nuCotiza) {
		this.nuCotiza = nuCotiza;
	}

	public String getFeCotiza() {
		return feCotiza;
	}

	public void setFeCotiza(String feCotiza) {
		this.feCotiza = feCotiza;
	}
