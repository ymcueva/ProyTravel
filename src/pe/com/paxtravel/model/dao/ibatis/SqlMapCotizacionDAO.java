...
public class SqlMapCotizacionDAO extends SqlMapClientDaoSupport implements
	...
	public List<CotizacionBean> listaCotizacion(CotizacionBean cotizacionBean) {
		...
		listaCotizacion = getSqlMapClientTemplate().queryForList(
				"cotizacion.listarCotizacion", cotizacionBean);
	...
	public String generarNumeroCotizacion() {
		...
		numeroCotizacion = (String) getSqlMapClientTemplate().queryForObject(
				"cotizacion.obtenerNumeroCotizacion");
	...
	public List<CiudadBean> listaCiudad(CiudadBean ciudadBean) {
		...
		listaCiudad = getSqlMapClientTemplate().queryForList(
				"cotizacion.listarCiudad", ciudadBean);
		return listaCiudad;
	}
	...
	public List<PaisBean> listaPais(PaisBean paisBean) {
		...
		listaPais = getSqlMapClientTemplate().queryForList(
				"cotizacion.listarPais", paisBean);
		return listaPais;
	}
	...
	public int registrarCotizacion(CotizacionBean cotizacionBean) {
		// new
		// SqlMapClientTemplate(getSqlMapClientTemplate().getSqlMapClient()).update("cotizacion.insertarCotizacion",
		// cotizacionBean);
		System.out.println("Iniciando Ibatis...");
		System.out.println("Id:"
				+ getSqlMapClientTemplate().insert(
						"cotizacion.insertarCotizacion", cotizacionBean));
	...
	public int registrarMotivo(MotivoViajeBean motivoViajeBean) {
		new SqlMapClientTemplate(getSqlMapClientTemplate().getSqlMapClient())
				.update("cotizacion.insertarMotivoViaje", motivoViajeBean);
		return 1;
	}
	...
	public int registrarHabitacion(HotelHabitacionBean hotelHabitacionBean) {
		new SqlMapClientTemplate(getSqlMapClientTemplate().getSqlMapClient())
				.update("cotizacion.insertarHabitacionHotel",
						hotelHabitacionBean);
		return 1;
	}
	...
	public int registrarServicio(ServicioAdicionalBean servicioAdicionalBean) {
		new SqlMapClientTemplate(getSqlMapClientTemplate().getSqlMapClient())
				.update("cotizacion.insertarServicioAdicional",
	...
	public int registrarCotizacionTicket(CotizacionBean cotizacionBean) {
		new SqlMapClientTemplate(getSqlMapClientTemplate().getSqlMapClient())
				.update("cotizacion.insertarCotizacionTicket", cotizacionBean);
		return 1;
	}
	...
	public int registrarCotizacionDetalleTicket(
		...
		new SqlMapClientTemplate(getSqlMapClientTemplate().getSqlMapClient())
				.update("cotizacion.insertarCotizacionDetalleTicket",
	...
	public List<ClienteBean> obtenerNombreCliente(ClienteBean clienteBean) {
		...
		cliente = getSqlMapClientTemplate().queryForList(
				"cotizacion.obtenerNombreCliente", clienteBean);
		return cliente;
	}
	...
	public FareInfoBean getConsolidador(FareInfoBean fareInfoBean) {
		return (FareInfoBean) getSqlMapClientTemplate().queryForObject(
				"cotizacion.getConsolidador", fareInfoBean);
	}
	...
	public int registrarConsolidador(
		...
		new SqlMapClientTemplate(getSqlMapClientTemplate().getSqlMapClient())
				.update("cotizacion.insertarCotizacionDetalleTicketVueloTab2",
						fareInfoBean);
		return 1;
	}
	...
	public int actualizarCotizacion(CotizacionBean cotizacionBean) {
		new SqlMapClientTemplate(getSqlMapClientTemplate().getSqlMapClient())
				.update("cotizacion.actualizarEstadoCotizacion", cotizacionBean);
		return 1;
	}
	...
	public List<PaqueteManagerBean> listarPaqueteDestino(PaqueteManagerBean p) {
		...
		listaPaqueteDestino = getSqlMapClientTemplate().queryForList(
				"cotizacion.listarPaqueteDestinos", p);
	...
	public CotizacionBean obtenerCotizacion(CotizacionBean cotizacionBean) {
		return (CotizacionBean) getSqlMapClientTemplate().queryForObject(
				"cotizacion.getCotizacionResume", cotizacionBean);
	}

	@Override
	public PaqueteResumeBean obtenerPaquete(PaqueteResumeBean paquete) {
		return (PaqueteResumeBean) getSqlMapClientTemplate().queryForObject(
				"cotizacion.getPaqueteResume", paquete);
	}
	...
	public List<PaqueteResumeBean> listarPaqueteDetail(PaqueteResumeBean p) {
		...
		lista = getSqlMapClientTemplate().queryForList(
				"cotizacion.listarPaqueteDetail", p);
		return lista;
	}
	...
	public int registrarExpedienteLog(ExpedienteLogBean expedienteLogBean) {
		new SqlMapClientTemplate(getSqlMapClientTemplate().getSqlMapClient())
				.update("cotizacion.insertarExpedienteLog", expedienteLogBean);
		return 1;
	}
	...
	public List<CotizacionDetalleBean> listarDestinosDetail(
		...
		return getSqlMapClientTemplate().queryForList(
				"cotizacion.listarDestinosDetail", cotizacionDetalleBean);
	}
