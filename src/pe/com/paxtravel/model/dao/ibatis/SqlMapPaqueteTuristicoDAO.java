...
public class SqlMapPaqueteTuristicoDAO extends SqlMapClientDaoSupport implements
		PaqueteTuristicoDAO {

	@SuppressWarnings("unchecked")
	@Override
	public List<PaqueteTuristicoBean> listaPaqueteTuristico(
			PaqueteTuristicoBean paqueteTuristicoBean) {
		List<PaqueteTuristicoBean> listaPaquete = null;
		listaPaquete = getSqlMapClientTemplate()
				.queryForList("paqueteturistico.listarPaqueteTuristico",
	...
	public List<PaqueteTuristicoBean> obtenerPaqueteTuristico(
			PaqueteTuristicoBean paqueteTuristicoBean) {
		List<PaqueteTuristicoBean> listaPaquete = null;
		listaPaquete = getSqlMapClientTemplate().queryForList(
				"paqueteturistico.obtenerPaqueteTuristico",
				paqueteTuristicoBean);
		return listaPaquete;
	}
	...
	public List<TourBean> listaTour(TourBean tourBean) {
		...
		listaTour = getSqlMapClientTemplate().queryForList(
				"paqueteturistico.listarTour", tourBean);
		return listaTour;
	}
	...
	public List<TourBean> listaTourBusqueda(TourBean tourBean) {
		List<TourBean> listaTour = null;
		listaTour = getSqlMapClientTemplate().queryForList(
				"paqueteturistico.listarTourBusqueda", tourBean);
		return listaTour;
	}
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<HotelHabitacionBean> listaTipoHabitacion(
		...
		listaHotelHabitacion = getSqlMapClientTemplate().queryForList(
				"paqueteturistico.listarTipoHabitacion", hotelHabitacionBean);
	...
	public List<HotelHabitacionBean> obtenerTipoHabitacion(
		...
		List<HotelHabitacionBean> listaHotelHabitacion = null;
		listaHotelHabitacion = getSqlMapClientTemplate().queryForList(
				"paqueteturistico.obtenerDatosTipoHabitacion",
				hotelHabitacionBean);
		return listaHotelHabitacion;
	}
	...
	public List<PaqueteTuristicoDestinoHotelBean> obtenerDetalleHotelPaquete(
		...
		lista = getSqlMapClientTemplate().queryForList(
				"paqueteturistico.listarDetalleHotel",
				paqueteTuristicoDestinoHotelBean);
		return lista;
	}
	...
	public int GrabarPaqueteTuristico(PaqueteTuristicoBean paqueteTuristicoBean) {
		// new
		// SqlMapClientTemplate(getSqlMapClientTemplate().getSqlMapClient()).insert("paqueteturistico.insertarPaqueteTuristico",
		// paqueteTuristicoBean);
		getSqlMapClientTemplate().insert(
				"paqueteturistico.insertarPaqueteTuristico",
				paqueteTuristicoBean);
	...
	public int RegistrarPaqueteTuristicoDestino(
		...
		new SqlMapClientTemplate(getSqlMapClientTemplate().getSqlMapClient())
				.insert("paqueteturistico.insertarPaqueteTuristicoDestino",
						paqueteTuristicoDestinoBean);
		return 1;
	}
	...
	public int RegistrarPaqueteTuristicoDestinoTour(
		...
		new SqlMapClientTemplate(getSqlMapClientTemplate().getSqlMapClient())
				.insert("paqueteturistico.insertarPaqueteTuristicoDestinoTour",
						paqueteTuristicoDestinoTourBean);
		return 1;
	}

	@Override
	public int eliminaDestinoPaqueteTuristico(
			PaqueteTuristicoBean paqueteTuristicoBean) {
		new SqlMapClientTemplate(getSqlMapClientTemplate().getSqlMapClient())
				.delete("paqueteturistico.eliminaPaqueteDestino",
						paqueteTuristicoBean);
	...
	@Override
	public int eliminaDestinoHotelPaqueteTuristico(
			PaqueteTuristicoBean paqueteTuristicoBean) {
		new SqlMapClientTemplate(getSqlMapClientTemplate().getSqlMapClient())
				.delete("paqueteturistico.eliminaPaqueteDestinoHotel",
						paqueteTuristicoBean);
	...
	@Override
	public int eliminaDestinoTourPaqueteTuristico(
			PaqueteTuristicoBean paqueteTuristicoBean) {
		new SqlMapClientTemplate(getSqlMapClientTemplate().getSqlMapClient())
				.delete("paqueteturistico.eliminaPaqueteDestinoTour",
						paqueteTuristicoBean);
	...
	@Override
	public int eliminaDestinoTicketPaqueteTuristico(
			PaqueteTuristicoBean paqueteTuristicoBean) {
		new SqlMapClientTemplate(getSqlMapClientTemplate().getSqlMapClient())
				.delete("paqueteturistico.eliminaPaqueteDestinoTicket",
						paqueteTuristicoBean);
	...
	public int RegistrarPaqueteTuristicoTicket(
		...
		new SqlMapClientTemplate(getSqlMapClientTemplate().getSqlMapClient())
				.insert("paqueteturistico.insertarPaqueteTuristicoTicket",
						paqueteTuristicoTicketBean);
		return 1;
	}
	...
	public int RegistrarPaqueteTuristicoDestinoHotel(
			PaqueteTuristicoDestinoHotelBean paqueteTuristicoDestinoHotelBean) {
		new SqlMapClientTemplate(getSqlMapClientTemplate().getSqlMapClient())
				.insert("paqueteturistico.insertarPaqueteTuristicoDestinoHotel",
						paqueteTuristicoDestinoHotelBean);
		return 1;
	}
	...
	public String obtenerCodigoPaqTuristico() {
		String codigo = (String) getSqlMapClientTemplate().queryForObject(
				"paqueteturistico.obtenerCodigoInseminacion");
		return codigo;
	}
	...
	public int actualizarEstadoPaqueteTuristico(
			PaqueteTuristicoBean paqueteTuristicoBean) {
		new SqlMapClientTemplate(getSqlMapClientTemplate().getSqlMapClient())
				.update("paqueteturistico.actualizarEstadoPaqueteTuristico",
						paqueteTuristicoBean);
		return 1;
	}
