...
<link href="resources/css/creditscard.css" rel="stylesheet">
										...
										<form class="form-horizontal">
											<div class="form-group">
												<label class="control-label col-sm-2">Nro.
													Cotización</label>
												<div class="col-sm-4">
													<label class="form-control">234567890</label>
												</div>
												<label class="control-label col-sm-2">Fecha
													Cotización</label>
												<div class="col-sm-3">
													<label class="form-control">2017-01-01</label>
												</div>
											</div>
											<div class="form-group">
												<label class="control-label col-sm-2">Cliente</label>
												<div class="col-sm-4">
													<label class="form-control">Daniel Olano Burga</label>
												</div>
												<label class="control-label col-sm-2">Tipo / Num.
													Documento</label>
												<div class="col-sm-3">
													<label class="form-control">DNI / 12345678</label>
												</div>
											</div>
													...
													<div class="panel-body">
														<div class="row">
															<div class="form-group">
																...
																<div class="col-sm-2">
																	<label class="form-control">2018-01-01</label>
																</div>
															</div>
															<div class="form-group">
																<label class="control-label col-sm-2">Nombre
																	Paquete</label>
																<div class="col-sm-5">
																	<label class="form-control">Lima - Cuzco -
																		Arequipa - Lima</label>
																</div>
															...
															<div class="form-group">
																<label class="control-label col-sm-2">Precio
																	Total</label>
																<div class="col-sm-2">
																	<label class="form-control">1200.50</label>
																</div>
															</div>
															<div class="form-group">
																					...
																					<table id="tblListaDestinos"
																						...
																						<thead>
																							<tr>
																								...
																								<th width="10%" class="text-center">Servicios
																								</th>
																							</tr>
																						</thead>
																						<tbody>
										...
										<form class="form-horizontal">
											<div class="form-group">
												...
												<div class="col-sm-9">
													<div class="cc-selector-2">
														<input id="visa2" type="radio" name="creditcard"
															value="visa" /> <label class="drinkcard-cc visa"
															for="visa2">VISA</label> <input id="mastercard2"
															type="radio" name="creditcard" value="mastercard" /> <label
															class="drinkcard-cc mastercard" for="mastercard2">MASTERCARD</label>
													</div>
												</div>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-sm-3">
													<input id="txtCodSeg"
														onkeypress="return validarNumeroLetra(event)"
														name="codSeg" type="text" maxlength="30"
														class="form-control">
												</div>
											</div>
											<div class="form-group">
