...
<meta charset="utf-8">
	...
	function inicia(){
		...
		$("#selTipoPrograma").on("change",function(){
			...
			if ($(this).val() == 0){
				...
				document.getElementById("selPaisOrigenPaquete").options[0].value = "";
		...
		$("#selPaisDestino").on("change",function(){
		    ...
		    $("#divFechaPartida,#divFechaRetorno").datetimepicker({
		    	locale: "es",
		    	language: 'es',
		    	autoClose : true,
		    	format: 'DD/MM/YYYY',
		...
		/* $('#divFechaPartida').datetimepicker({language : 'es',
            autoClose : true, 			
            format: 'DD/MM/YYYY',
            pickTime: false,
			useCurrent: false,
			onSelect: function(dateText, inst) {                                                                                                                                                                               
	            $("#divFechaRetorno").datetimepicker('option', 'minDate', dateText);                                                                                                                                                         
	          } 
        });
        
        $('#divFechaRetorno').datetimepicker({language : 'es',
            autoClose : true, 					
            format: 'DD/MM/YYYY',
            pickTime: false,
			useCurrent: false,
			onSelect: function(dateText, inst) {                                                                                                                                                                               
	            $("#divFechaPartida").datetimepicker('option', 'maxDate', dateText);                                                                                                                                                         
	          }  }); */
	...
	function agregarDestino(){
		...
		console.log("Agregar Destinos........... " + dataJson.length);
	...
	function validarCotiPaquete() {
		...
		if ( $("#selTipoPrograma").val() == 0 ){
			msgHTML += 'Debe seleccionar el tipo de programa. <br />';
		}		
		...
		if ( dataJson.length <= 0 ) {
			msgHTML += 'Ingrese al menos un destino. <br />';
		}		
		...
		if ( $("#txtObservacion").val() == '' ){
			msgHTML += 'Ingrese una observacion. <br />';
		}				
												...
												<div class="col-sm-12">
													...
													<div class="form-group">
														...
														<div class="form-group">
															...
															<div class="col-sm-3">
																<input name="presupuestoMinimo" id="txtPresupuestoMinimo" type="text" class="form-control tamanoMaximo" onkeypress="return validarPrecio(event)" ></input>
															</div>
