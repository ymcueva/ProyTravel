...
// 			var codigoAnimal = $("#txtCod_Ani").val();
// 			$(location).prop( 'href', '${pageContext.request.contextPath}/continuarRegistro?codigoAnimal='+codigoAnimal);
			alert("form: " + $('#formProduccion').serialize());
			$.ajax({
...
// 	            	alert(response);
	            	$(location).prop( 'href', '${pageContext.request.contextPath}/abrirCompletarProduccion?');
	            },
                ...
                <div class="panel-body">
                	<div class="row">
                		<div class="col-sm-12">
							...
							<form id="formProduccion" role="form" class="form-horizontal" method="post">
								...
								<div class="form-group">
									...
									<div class="col-sm-8 control-label" style="text-align:left">
										<input id="txtCod_Ani" name="codigoAnimal" type="text" maxlength="5" class="form-control" style="width:300px">
									</div>
								</div>
								...
								<div class="form-group">
									<div class="col-sm-6" style="text-align:center">
										<button id="btnLimpiar" type="button" class="btn btn-primary centro" onclick="limpiar()" style="width:220px;" title="Limpiar">Limpiar</button>
									</div>
									<div class="col-sm-6" style="text-align:center">
										<button id="btnContinuar" class="btn btn-primary" style="width:220px;" title="Continuar">Continuar</button>
									</div>
								</div>
							</form>
                		</div>
